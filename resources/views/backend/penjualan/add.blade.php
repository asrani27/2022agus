...
<div class="content-wrapper">
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Transaksi Distribusi</h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
        ...
        <div class="row">
          <div class="col-12">
            <div class="card card-outline card-primary">
                <!-- /.card-header -->
                <!-- form start -->
                <form class="form-horizontal" method="POST" action="{{route('penjualan')}}">
                    @csrf
                  <div class="card-body">
                    <div class="form-group row">
                      <label for="inputEmail3" class="col-sm-2 col-form-label">No. Transaksi</label>
                      <div class="col-sm-10">
                      <input type="text" class="form-control form-control-sm" name="no_transaksi" value="TRSPJ-{{$kode}}">
                      </div>
                      <label for="inputEmail3" class="col-sm-2 col-form-label">Tanggal</label>
                      <div class="col-sm-10">
                      <input type="text" class="form-control form-control-sm" name="created_at" value="{{\Carbon\Carbon::now()}}">
                      </div>
                      <label for="inputEmail3" class="col-sm-2 col-form-label">Retail</label>
                      <div class="col-sm-10">
                          <select name="retail_id" class="form-control form-control-sm" required>
                ...
                <form class="form-horizontal" method="POST" action="{{route('tambahkeranjang')}}">
                  ...
                  <div class="card-body">
                    <div class="form-group row">
                      ...
                      <input type="hidden" class="form-control form-control-sm" name="type" value="penjualan">
                      </div>
